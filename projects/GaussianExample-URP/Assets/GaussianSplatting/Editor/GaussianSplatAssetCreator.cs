...
namespace GaussianSplatting.Editor
{
	...
	public class GaussianSplatAssetCreator : EditorWindow
	{
		...
		static unsafe void EmitEncodedVector(float3 v, byte* outputPtr, GaussianSplatAsset.VectorFormat format, bool convertYup = false)
		{
			switch (format)
			{
		...
		struct CreatePositionsDataJob : IJobParallelFor
		{
			...
			public unsafe void Execute(int index)
			{
				...
				EmitEncodedVector(m_Input[index].pos, outputPtr, m_Format, false);
			}
		}
